...
window.System = Object.assign(window.System || {}, {
  ...
  modelToFormData: function modelToFormData(model) {
...
(function () {
  var loading;
  var activityMessageText = 'Working...';
  window.System = Object.assign(window.System, {
    setActivityMessageText: function setActivityMessageText() {
      var text = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'Working...';
  ...
  window.$script('https://cdn.jsdelivr.net/npm/sweetalert2@9', function () {
    ...
    var Alert = window.Swal.mixin({
      allowOutsideClick: false,
      allowEscapeKey: false
    });
    var ConfirmModal = window.Swal.mixin({
      showConfirmButton: true,
      showCancelButton: true
    });
    window.System = Object.assign(window.System, {
      alert: function alert(title, content, icon) {
      ...
      activityAlert: function activityAlert(text) {
        var loading_anim = '<div class="progress-circle-indeterminate" data-color="primary"></div>';
    ...
    window.$script.ready('core', function () {
      ...
      window.xhook.after(function (request, response) {
        ...
        var hookIndex = _.findIndex(window.System.httpHooks, {
          'url': request.url
        });
...
module.exports = __webpack_require__(/*! C:\laragon\www\covid19\themes\Pages\resources\js\dependencies.js */"./resources/js/dependencies.js");
