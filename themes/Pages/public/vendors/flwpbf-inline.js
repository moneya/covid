...
(function(window) {
    ...
    function loadIframe (data, is_hide) {
        ...
        modalframesource.src = 'https://checkout.flutterwave.com/?'
    ...
    function addQueryToIframe(data, callback) {
        ...
        if (window.location.href.includes('https://api.ravepay.co/flwv3-pug/getpaidx/api/hosted_pay/')) {
            ...
            let postmessagesource = 'https://checkout.flutterwave.com';
            ...
            if (!readyToReceive) {
                ...
                modalframesource.src = 'https://checkout.flutterwave.com/?' + generateQueryString(_data);
